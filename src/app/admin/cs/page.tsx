...
const DEFAULT_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer: "네, 무료 플랜으로 매월 사업계획서 1건을 작성하실 수 있습니다. 더 많은 기능이 필요하시면 스타터 또는 프로 플랜을 이용해보세요.",
  },
  {
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { title: "업그레이드 안내", text: "현재 이용 중인 무료 플랜에서는 해당 기능이 제한됩니다. 스타터 플랜 이상에서 이용 가능하며, 요금제 페이지에서 업그레이드하실 수 있습니다." },
